...
const MobileInboxPage = lazy(() => import('./pages/m-inbox'));
...
<Route path="/team/invite" component={() => <Suspense fallback={<div>Loading...</div>}><TeamInvite /></Suspense>} />
      ...
      <Route path="/m-inbox" component={() => <Suspense fallback={<div>Loading...</div>}><MobileInboxPage /></Suspense>} /> 
      <Route path="/inbox" component={() => <Suspense fallback={<div>Loading...</div>}><MobileInboxPage /></Suspense>} /> 
