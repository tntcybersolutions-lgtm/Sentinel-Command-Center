...
async function generateAwardPdf(snapshot: any, version: number): Promise<Uint8Array> {
  ...
  function addPage() {
    ...
    y = pageHeight - margin;
    currentPage.drawText(`Sentinel Command Center — Award Packet v${version}`, {
  ...
  currentPage.drawText("SENTINEL COMMAND CENTER", {
  ...
  drawLine(y);
  y -= 15;
  currentPage.drawText("This document was auto-generated by Sentinel + Herbie.", {
